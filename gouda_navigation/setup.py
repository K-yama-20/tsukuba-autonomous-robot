...
setup(name='gouda_navigation', version='0.1.0', packages=['gouda_navigation'],
    ...
    entry_points={'console_scripts': ['time_sync_gate = gouda_navigation.time_sync:main', 'autonomy_mvp = gouda_navigation.autonomy_mvp:main', 'follower = gouda_navigation.node:main', 'glim_odom_tf = gouda_navigation.glim_odom_tf:main']})
